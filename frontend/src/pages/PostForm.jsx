...
const PostForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.message || "Erro ao salvar a postagem no servidor.",
      );
    } finally {
      setSubmitting(false);
    }
  ...
  if (loading) {
    return (
      <div
        style={{ textAlign: "center", padding: "4rem 1rem", color: "#94a3b8" }}
      >
    ...
    <div style={{ maxWidth: "750px", margin: "0 auto" }}>
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ color: "#94a3b8", fontSize: "0.9rem" }}>
              Preencha os campos abaixo para disponibilizar o conteúdo para os
              estudantes.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            <Link to="/admin" className="btn btn-secondary btn-cancel">
              Cancelar
            </Link>
            <button
              type="submit"
